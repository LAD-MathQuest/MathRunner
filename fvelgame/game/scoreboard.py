...
class Scoreboard:
    ...
    def __init__(self, param ):
        ...
        self.rect    = param.text_rect
        self.bgcolor = param.text_bgcolor
        self.fgcolor = param.text_fgcolor

        self.ost  = OnScreenText(self.rect, 3, 2, self.fgcolor, self.bgcolor)
        self.rect = self.ost.column_width(['Velocidade: ', '000000'])

    #--------------------------------------------------------------------------#
    def draw(self, surf, score, velocity, elapsed_time):

        surf.fill( self.bgcolor, self.rect )
