...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_TrackKills.setText(QCoreApplication.translate("MainWindow", u"Touching track boundaries kills the player", None))
        self.checkBox_TrackMinimumKills.setText(QCoreApplication.translate("MainWindow", u"Minimum", None))
        self.checkBox_TrackMaximumKills.setText(QCoreApplication.translate("MainWindow", u"Maximum", None))
...
#if QT_CONFIG(statustip)
        self.tabBoundary.setStatusTip(QCoreApplication.translate("MainWindow", u"Define track boundary", None))
#endif // QT_CONFIG(statustip)
        ...
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabBoundary), QCoreApplication.translate("MainWindow", u"Boundary", None))
