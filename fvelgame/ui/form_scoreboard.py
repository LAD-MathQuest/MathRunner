...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("Dialog", u"Font", None))
        self.radioButton_3.setText(QCoreApplication.translate("Dialog", u"Load from file", None))
        self.pushButton_3.setText(QCoreApplication.translate("Dialog", u"Select", None))
        self.radioButton.setText(QCoreApplication.translate("Dialog", u"System font", None))
        self.radioButton_2.setText(QCoreApplication.translate("Dialog", u"Resource font", None))
        self.label_9.setText(QCoreApplication.translate("Dialog", u"Font size", None))
        self.label_10.setText(QCoreApplication.translate("Dialog", u"Line spacing", None))
        self.pushButton.setText(QCoreApplication.translate("Dialog", u"Font color", None))
        self.pushButton_2.setText(QCoreApplication.translate("Dialog", u"Background color", None))
        self.groupBox.setTitle(QCoreApplication.translate("Dialog", u"Contents", None))
        self.checkBox_2.setText(QCoreApplication.translate("Dialog", u"Game name", None))
        self.checkBox_4.setText(QCoreApplication.translate("Dialog", u"Text", None))
        self.lineEdit.setText(QCoreApplication.translate("Dialog", u"Texto", None))
        self.checkBox.setText(QCoreApplication.translate("Dialog", u"Points", None))
        self.checkBox_3.setText(QCoreApplication.translate("Dialog", u"Velocity", None))
        self.checkBox_5.setText(QCoreApplication.translate("Dialog", u"Elapsed time", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("Dialog", u"Preview", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"FVelGame", None))
