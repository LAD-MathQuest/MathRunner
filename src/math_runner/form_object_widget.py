...
class Ui_ObjectWidget(object):
    def setupUi(self, ObjectWidget):
        ...
        self.horizontalSpacer_SelectImage = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_Points = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_Sound = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, ObjectWidget):
        ObjectWidget.setWindowTitle(QCoreApplication.translate("ObjectWidget", u"Forma", None))
        self.label_Image.setText("")
        self.pushButton_SelectImage.setText(QCoreApplication.translate("ObjectWidget", u"Editar Imagem", None))
        self.label_Size.setText(QCoreApplication.translate("ObjectWidget", u"Tamanho", None))
        self.checkBox_KeepAspectRatio.setText(QCoreApplication.translate("ObjectWidget", u"Manter a propor\u00e7\u00e3o", None))
        self.label_Points.setText(QCoreApplication.translate("ObjectWidget", u"Points", None))
        self.label_Sound.setText(QCoreApplication.translate("ObjectWidget", u"Som de contato", None))
        self.pushButton_SoundSelect.setText(QCoreApplication.translate("ObjectWidget", u"Selecionar", None))
        self.pushButton_SoundRemove.setText(QCoreApplication.translate("ObjectWidget", u"Remover", None))
        self.pushButton_SoundPlay.setText(QCoreApplication.translate("ObjectWidget", u"Tocar", None))
        self.label_Volume.setText(QCoreApplication.translate("ObjectWidget", u"Volume", None))
        self.pushButton.setText(QCoreApplication.translate("ObjectWidget", u"Duplicar Objeto", None))
        self.pushButton_Delete.setText(QCoreApplication.translate("ObjectWidget", u"Deletar Objeto", None))
    # retranslateUi
