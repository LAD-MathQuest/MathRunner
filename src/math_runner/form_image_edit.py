...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNew.setText(QCoreApplication.translate("MainWindow", u"Novo de imagem", None))
        self.actionOpen.setText(QCoreApplication.translate("MainWindow", u"Abrir", None))
        self.actionSelect.setText(QCoreApplication.translate("MainWindow", u"Selecionar", None))
        self.actionCancel.setText(QCoreApplication.translate("MainWindow", u"Cancelar", None))
        self.actionNew_shape.setText(QCoreApplication.translate("MainWindow", u"Nova forma", None))
        self.actionFill_color.setText(QCoreApplication.translate("MainWindow", u"Preencher cor", None))
        self.actionFlip_left_right.setText(QCoreApplication.translate("MainWindow", u"Girar para o lado", None))
        self.actionFlip_up_down.setText(QCoreApplication.translate("MainWindow", u"Girar para cima", None))
        self.actionRotate_90.setText(QCoreApplication.translate("MainWindow", u"Rotacionar 90", None))
        self.actionCrop.setText(QCoreApplication.translate("MainWindow", u"Cortar", None))
        self.actionSet_transparence.setText(QCoreApplication.translate("MainWindow", u"Transpar\u00eancia", None))
        self.actionUndo.setText(QCoreApplication.translate("MainWindow", u"Desfazer", None))
        self.actionRedo.setText(QCoreApplication.translate("MainWindow", u"Refazer", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Exibi\u00e7\u00e3o de Imagem", None))
