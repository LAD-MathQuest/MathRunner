...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/resources/icons/theme/media-playback-start.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Run.setIcon(icon)
        self.action_Exit = QAction(MainWindow)
        self.action_Exit.setObjectName(u"action_Exit")
        icon1 = QIcon()
        icon1.addFile(u":/icons/resources/icons/theme/exit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Exit.setIcon(icon1)
        self.action_About = QAction(MainWindow)
        self.action_About.setObjectName(u"action_About")
        self.action_About.setEnabled(False)
        icon2 = QIcon()
        icon2.addFile(u":/icons/resources/icons/theme/help-about.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/resources/icons/theme/help-contextual.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Contents.setIcon(icon3)
        self.action_Undo = QAction(MainWindow)
        self.action_Undo.setObjectName(u"action_Undo")
        self.action_Undo.setEnabled(False)
        icon4 = QIcon()
        icon4.addFile(u":/icons/resources/icons/theme/edit-undo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Undo.setIcon(icon4)
        self.action_Redo = QAction(MainWindow)
        self.action_Redo.setObjectName(u"action_Redo")
        self.action_Redo.setEnabled(False)
        icon5 = QIcon()
        icon5.addFile(u":/icons/resources/icons/theme/edit-redo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/resources/icons/theme/document-revert.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Reset.setIcon(icon6)
        self.action_New = QAction(MainWindow)
        self.action_New.setObjectName(u"action_New")
        icon7 = QIcon()
        icon7.addFile(u":/icons/resources/icons/theme/document-new.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_New.setIcon(icon7)
        self.action_Open = QAction(MainWindow)
        self.action_Open.setObjectName(u"action_Open")
        icon8 = QIcon()
        icon8.addFile(u":/icons/resources/icons/theme/document-open.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_Open.setIcon(icon8)
        self.action_Save = QAction(MainWindow)
        self.action_Save.setObjectName(u"action_Save")
        self.action_Save.setEnabled(False)
        icon9 = QIcon()
        icon9.addFile(u":/icons/resources/icons/theme/document-save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/resources/icons/theme/system-run.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/resources/icons/theme/document-save-as.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.radioButton_VerticalScrolling = QRadioButton(self.groupBox_Game)
        self.radioButton_VerticalScrolling.setObjectName(u"radioButton_VerticalScrolling")

        self.horizontalLayout_7.addWidget(self.radioButton_VerticalScrolling)
        ...
        self.label_TrackKills = QLabel(self.groupBox_Game)
        self.label_TrackKills.setObjectName(u"label_TrackKills")

        self.horizontalLayout_8.addWidget(self.label_TrackKills)

        self.checkBox_TrackMinimumKills = QCheckBox(self.groupBox_Game)
        self.checkBox_TrackMinimumKills.setObjectName(u"checkBox_TrackMinimumKills")

        self.horizontalLayout_8.addWidget(self.checkBox_TrackMinimumKills)

        self.checkBox_TrackMaximumKills = QCheckBox(self.groupBox_Game)
        self.checkBox_TrackMaximumKills.setObjectName(u"checkBox_TrackMaximumKills")

        self.horizontalLayout_8.addWidget(self.checkBox_TrackMaximumKills)
        ...
        self.verticalSpacer_25 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_21.addItem(self.verticalSpacer_25)

        self.verticalSpacer_26 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_21.addItem(self.verticalSpacer_26)

        self.verticalSpacer_24 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_21.addItem(self.verticalSpacer_24)

        self.verticalSpacer_15 = QSpacerItem(20, 128, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.horizontalSpacer_ObstacleFrequency = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.verticalSpacer_ObstacleFrequency_1 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_17.addItem(self.verticalSpacer_ObstacleFrequency_1)

        self.verticalSpacer_ObstacleFrequency_2 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_17.addItem(self.verticalSpacer_ObstacleFrequency_2)

        self.verticalSpacer_ObstacleFrequency_3 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_17.addItem(self.verticalSpacer_ObstacleFrequency_3)

        self.verticalSpacer_ObstacleFrequency_4 = QSpacerItem(20, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.horizontalSpacer_ObstacleNew = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.tabBoundary = QWidget()
        self.tabBoundary.setObjectName(u"tabBoundary")
        self.tabBoundary.setEnabled(True)
        self.verticalLayout_5 = QVBoxLayout(self.tabBoundary)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_3 = QVBoxLayout()
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.gridLayout_5 = QGridLayout()
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.lineEdit_FunctionTrackMaximum = QLineEdit(self.tabBoundary)
        ...
        self.lineEdit_FunctionTrackMinimum = QLineEdit(self.tabBoundary)
        ...
        self.label_TrackMaximum = QLabel(self.tabBoundary)
        ...
        self.label_TrackMinimum = QLabel(self.tabBoundary)
        ...
        self.label_TrackMinimumEqual = QLabel(self.tabBoundary)
        ...
        self.label_TrackMaximumEqual = QLabel(self.tabBoundary)
        ...
        self.plotBoundary = PlotWidget(self.tabBoundary)
        self.plotBoundary.setObjectName(u"plotBoundary")
        sizePolicy3.setHeightForWidth(self.plotBoundary.sizePolicy().hasHeightForWidth())
        self.plotBoundary.setSizePolicy(sizePolicy3)
        self.plotBoundary.setAutoFillBackground(True)

        self.verticalLayout_5.addWidget(self.plotBoundary)

        self.tabWidget_Game.addTab(self.tabBoundary, "")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"MathRunner", None))
        self.action_Run.setText(QCoreApplication.translate("MainWindow", u"&Rodar jogo", None))
#if QT_CONFIG(statustip)
        self.action_Run.setStatusTip(QCoreApplication.translate("MainWindow", u"Rodar jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Run.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Return", None))
#endif // QT_CONFIG(shortcut)
        self.action_Exit.setText(QCoreApplication.translate("MainWindow", u"Sair", None))
#if QT_CONFIG(statustip)
        self.action_Exit.setStatusTip(QCoreApplication.translate("MainWindow", u"Sair do editor de jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        ...
        self.action_Contents.setText(QCoreApplication.translate("MainWindow", u"Conte\u00fados", None))
#if QT_CONFIG(statustip)
        self.action_Contents.setStatusTip(QCoreApplication.translate("MainWindow", u"Conte\u00fados de Ajuda", None))
#endif // QT_CONFIG(statustip)
        self.action_Undo.setText(QCoreApplication.translate("MainWindow", u"Desfazer", None))
#if QT_CONFIG(statustip)
        self.action_Undo.setStatusTip(QCoreApplication.translate("MainWindow", u"Desfazer", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Undo.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Z", None))
#endif // QT_CONFIG(shortcut)
        self.action_Redo.setText(QCoreApplication.translate("MainWindow", u"Refazer", None))
#if QT_CONFIG(statustip)
        self.action_Redo.setStatusTip(QCoreApplication.translate("MainWindow", u"Refazer", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Redo.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+Z", None))
#endif // QT_CONFIG(shortcut)
        self.action_Reset.setText(QCoreApplication.translate("MainWindow", u"Resetar", None))
        self.action_New.setText(QCoreApplication.translate("MainWindow", u"&Novo", None))
#if QT_CONFIG(statustip)
        self.action_New.setStatusTip(QCoreApplication.translate("MainWindow", u"Criar nova defini\u00e7\u00e3o de jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(statustip)
        self.action_Open.setStatusTip(QCoreApplication.translate("MainWindow", u"Abrir defini\u00e7\u00e3o de jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Open.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+O", None))
#endif // QT_CONFIG(shortcut)
        self.action_Save.setText(QCoreApplication.translate("MainWindow", u"&Salvar", None))
#if QT_CONFIG(statustip)
        self.action_Save.setStatusTip(QCoreApplication.translate("MainWindow", u"Salvar defini\u00e7\u00e3o de jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Save.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.action_Build.setText(QCoreApplication.translate("MainWindow", u"Construir", None))
#if QT_CONFIG(statustip)
        self.action_Build.setStatusTip(QCoreApplication.translate("MainWindow", u"Construir execut\u00e1vel do jogo", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        self.action_Build.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+B", None))
#endif // QT_CONFIG(shortcut)
        self.action_Save_as.setText(QCoreApplication.translate("MainWindow", u"Salvar Como...", None))
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.tabGame.setStatusTip(QCoreApplication.translate("MainWindow", u"Definir propriedades do jogo", None))
#endif // QT_CONFIG(statustip)
        self.groupBox_Software.setTitle(QCoreApplication.translate("MainWindow", u"Programa", None))
        self.label_Author.setText(QCoreApplication.translate("MainWindow", u"Autor", None))
        self.pushButton_IconSelect.setText(QCoreApplication.translate("MainWindow", u"\u00cdcone", None))
        self.label_GameName.setText(QCoreApplication.translate("MainWindow", u"Nome do jogo", None))
        self.label_GameDescription.setText(QCoreApplication.translate("MainWindow", u"Descri\u00e7\u00e3o do jogo", None))
        self.label_GameIcon.setText("")
        self.groupBox_Game.setTitle(QCoreApplication.translate("MainWindow", u"Jogo", None))
        self.label_ScrollDirection.setText(QCoreApplication.translate("MainWindow", u"Dire\u00e7\u00e3o de rolagem: ", None))
        self.radioButton_VerticalScrolling.setText(QCoreApplication.translate("MainWindow", u"Vertical", None))
        self.radioButton_HorizontalScrolling.setText(QCoreApplication.translate("MainWindow", u"Horizontal", None))
        self.label_TrackKills.setText(QCoreApplication.translate("MainWindow", u"Tocar nos limites da pista mata o jogador", None))
        self.checkBox_TrackMinimumKills.setText(QCoreApplication.translate("MainWindow", u"M\u00ednimo", None))
        self.checkBox_TrackMaximumKills.setText(QCoreApplication.translate("MainWindow", u"M\u00e1ximo", None))
        self.label_ScoreTimeBonus.setText(QCoreApplication.translate("MainWindow", u"B\u00f4nus no tempo de pontua\u00e7\u00e3o", None))
        self.label_AmbienceSound.setText(QCoreApplication.translate("MainWindow", u"Som ambiente", None))
        self.pushButton_AmbienceSoundSelect.setText(QCoreApplication.translate("MainWindow", u"Selecionar", None))
        self.pushButton_AmbienceSoundRemove.setText(QCoreApplication.translate("MainWindow", u"Remover", None))
        self.pushButton_AmbienceSoundPlay.setText(QCoreApplication.translate("MainWindow", u"Tocar", None))
        self.label_AmbienceSoundVolume.setText(QCoreApplication.translate("MainWindow", u"Volume", None))
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabGame), QCoreApplication.translate("MainWindow", u"Jogo", None))
        self.groupBox_Background.setTitle(QCoreApplication.translate("MainWindow", u"Fundo de tela", None))
        self.pushButton_SelectBackgroundImage.setText(QCoreApplication.translate("MainWindow", u"Editar Imagem", None))
        self.checkBox_BackgroundImageScrolls.setText(QCoreApplication.translate("MainWindow", u"Rolar imagem de fundo", None))
        self.label_BackgroundImage.setText("")
        self.groupBox_Track.setTitle(QCoreApplication.translate("MainWindow", u"Caminho de fundo ", None))
        self.checkBox_DrawTrack.setText(QCoreApplication.translate("MainWindow", u"Desenhar caminho", None))
        self.pushButton_SelectTrackImage.setText(QCoreApplication.translate("MainWindow", u"Editar Imagem", None))
        self.label_TrackImage.setText("")
        self.groupBox_Scoreboard.setTitle(QCoreApplication.translate("MainWindow", u"Placar", None))
        ...
        self.groupBox_ScoreboardImage.setTitle(QCoreApplication.translate("MainWindow", u"Imagem", None))
        self.pushButton_SelectScoreboardImage.setText(QCoreApplication.translate("MainWindow", u"Editar Imagem", None))
        self.label_ScoreboardImagePosition.setText(QCoreApplication.translate("MainWindow", u"Posi\u00e7\u00e3o", None))
        self.label_ScoreboardImageWidth.setText(QCoreApplication.translate("MainWindow", u"Tamanho", None))
        self.checkBox_ScoreboardImageKeepAspectRatio.setText(QCoreApplication.translate("MainWindow", u"Manter propor\u00e7\u00e3o de aspecto", None))
        self.groupBox_ScoreboardText.setTitle(QCoreApplication.translate("MainWindow", u"Texto", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Configurar texto", None))
        self.label_ScoreboardTextPosition.setText(QCoreApplication.translate("MainWindow", u"Posi\u00e7\u00e3o na tela ", None))
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabAppearance), QCoreApplication.translate("MainWindow", u"Apar\u00eancia", None))
#if QT_CONFIG(statustip)
        self.tabObjects.setStatusTip(QCoreApplication.translate("MainWindow", u"Definir elementos visuais", None))
#endif // QT_CONFIG(statustip)
        self.label_PlayerImage.setText("")
        self.pushButton_SelectPlayerImage.setText(QCoreApplication.translate("MainWindow", u"Editar Imagem", None))
        self.label_PlayerSpeed.setText(QCoreApplication.translate("MainWindow", u"Velocidade", None))
        self.label_PlayerSize.setText(QCoreApplication.translate("MainWindow", u"Tamanho", None))
        self.checkBox_PlayerKeepAspectRatio.setText(QCoreApplication.translate("MainWindow", u"Manter a propor\u00e7\u00e3o", None))
        self.tabWidget_Objects.setTabText(self.tabWidget_Objects.indexOf(self.tab_Player), QCoreApplication.translate("MainWindow", u"Jogador", None))
        self.label_ObstacleFrequency.setText(QCoreApplication.translate("MainWindow", u"Frequ\u00eancia dos Obst\u00e1culos", None))
        self.pushButton_NewObstacle.setText(QCoreApplication.translate("MainWindow", u"Novo", None))
        self.tabWidget_Objects.setTabText(self.tabWidget_Objects.indexOf(self.tab_Obstacles), QCoreApplication.translate("MainWindow", u"Obst\u00e1culos", None))
        self.label_CollectiblesFrequency.setText(QCoreApplication.translate("MainWindow", u"Frequ\u00eancia dos Colecion\u00e1veis", None))
        self.pushButton_NewCollectible.setText(QCoreApplication.translate("MainWindow", u"Novo", None))
        self.tabWidget_Objects.setTabText(self.tabWidget_Objects.indexOf(self.tab_Collectibles), QCoreApplication.translate("MainWindow", u"Colecion\u00e1veis", None))
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabObjects), QCoreApplication.translate("MainWindow", u"Objetos", None))
#if QT_CONFIG(statustip)
        self.tabVelocity.setStatusTip(QCoreApplication.translate("MainWindow", u"Definir velocidade de rolagem", None))
#endif // QT_CONFIG(statustip)
        self.label_VelocityA.setText(QCoreApplication.translate("MainWindow", u"v(t) =", None))
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabVelocity), QCoreApplication.translate("MainWindow", u"Velocidade", None))
#if QT_CONFIG(statustip)
        self.tabBoundary.setStatusTip(QCoreApplication.translate("MainWindow", u"Definir borda da pista", None))
#endif // QT_CONFIG(statustip)
        self.label_TrackMaximum.setText(QCoreApplication.translate("MainWindow", u"M\u00e1ximo(x)", None))
        self.label_TrackMinimum.setText(QCoreApplication.translate("MainWindow", u"M\u00ednimo(x)", None))
        ...
        self.tabWidget_Game.setTabText(self.tabWidget_Game.indexOf(self.tabBoundary), QCoreApplication.translate("MainWindow", u"Borda", None))
        ...
        self.menuGame.setTitle(QCoreApplication.translate("MainWindow", u"Jogo", None))
        self.toolBar.setWindowTitle(QCoreApplication.translate("MainWindow", u"Barra de ferramentas", None))
    # retranslateUi
