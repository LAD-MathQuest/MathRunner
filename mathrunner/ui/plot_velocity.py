...
class PlotVelocity:
    ...
    def __init__(self, plot, color, velocity):
        ...
        p_raw = pg.PlotDataItem(np.array((0,par.PLOT_MAX_T)), np.array((0.5, 0.5)), pen=pen_raw)
        p_vel = pg.PlotDataItem(np.array((0,par.PLOT_MAX_T)), np.array((0.5, 0.5)), pen=pen_vel)
